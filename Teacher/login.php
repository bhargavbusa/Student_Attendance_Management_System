...
$sql ="SELECT * FROM tbl_teacher WHERE teacher_emailid=:teacher_emailid and teacher_password=:teacher_password";
          ...
          <div class="card-body p-5">
            ...
            <form method="post">
                <div class="form-outline mb-4">
                    ...
                    <input type="text" id="typeEmailX-2" class="form-control form-control-lg" name="teacher_emailid" />
                </div>

                <div class="form-outline mb-4">
                    <label class="form-label" for="typePasswordX-2">Password</label>
                    <input type="password" id="typePasswordX-2" class="form-control form-control-lg" name="teacher_password" />
                </div>
