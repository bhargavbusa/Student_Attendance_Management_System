...
if(isset($_POST['show_attendance']))
{
    ...
    echo "<script>window.location='show_attendance.php?tgrade_id=$grade_id&tdate=$tdate'</script>";
}
?>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form method="post" enctype="multipart/form-data">  
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8 ">
                                           <select name="grade_id" id="grade_id" class="form-control" required>
                                               ...
                                               <option value="00all">All Class</option>
                                               <?php
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                        <input type="submit" value="Show Attendance" name="show_attendance" class="btn btn-primary" >
                                        </div>
                                        <div class="col-sm-1"></div>
                                    </div>
                                </form>
